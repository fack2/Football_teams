...
INSERT INTO teams
  (id_countries,team_name, logo,description)
VALUES
  (1, 'Celta Vigo', 'public/assest/Celta_deVigo_logo.png', 'is a Spanish professional football club based in Vigo, Galicia, currently playing in La Liga. It was founded on 23 August 1923 following the merger of Real Vigo Sporting and Real Fortuna Football Club. Nicknamed Os Celestes (The Sky Blues), they play in sky blue shirts and socks along with white shorts. The clubs home stadium is the Abanca-Balaídos, which seats 29,000 spectators. Celta s name is derived from the Celts who were once present in the region. Its main rival is fellow Galician club Deportivo de La Coruña, with whom it contests the Galician derby.');
INSERT INTO teams
  (id_countries,team_name, logo,description)
VALUES
  (1, 'Granada', 'public/assest/Granada.png', 'is a Spanish football club in Granada, in the autonomous community of Andalusia. Founded on 6 April 1931, it plays in the La Liga. The club plays its home matches at the Estadio Nuevo Los Cármenes.
...
INSERT INTO teams
  (id_countries,team_name, logo,description)
VALUES
  (1, 'Real Madrid', 'public/assest/Real_Madrid.png', 'is a Spanish professional football club based in Madrid.
...
INSERT INTO teams
  (id_countries,team_name, logo,description)
VALUES
  (2, 'Arsenal', 'public/assest/Arsenal_FC.png', 'is a professional football club based in Islington, London, England, that plays in the Premier League, the top flight of English football. The Club has won 13 League titles, a record 13 FA Cups, 2 League Cups, 15 FA Community Shields, 1 League Centenary Trophy, 1 UEFA Cup Winners Cup and 1 Inter-Cities Fairs Cup.
